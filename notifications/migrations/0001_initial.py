    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('system', 'System'), ('deposit', 'Deposit'), ('withdrawal', 'Withdrawal'), ('investment', 'Investment'), ('earning', 'Earning'), ('kyc', 'KYC'), ('security', 'Security'), ('referral', 'Referral')], default='system', max_length=20)),
