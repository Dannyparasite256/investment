...
urlpatterns = [
    ...
    path('auth/password-reset/', platform_views.PasswordResetRequestAPI.as_view(), name='api-password-reset'),
    path('auth/password-reset/confirm/', platform_views.PasswordResetConfirmAPI.as_view(), name='api-password-reset-confirm'),
